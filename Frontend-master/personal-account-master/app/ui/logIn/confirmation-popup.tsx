...
export default function ConfirmationForm ({email, visCon, setVisCon, onLoginSuccess}: Props) {
    ...
    return (
        <div className="fixed top-0 left-0 flex justify-center items-center w-screen h-screen backdrop-blur-sm">
            <div className="flex flex-col items-center w-[664px] h-[447px] border-black rounded-[28px] border-[0.5px] bg-[#F1F1F1]/75 pt-[58px] shadow">
                ...
                <div className="mb-[48px]"><ConfirmationInput value={code} setValue={setCode}/></div>
