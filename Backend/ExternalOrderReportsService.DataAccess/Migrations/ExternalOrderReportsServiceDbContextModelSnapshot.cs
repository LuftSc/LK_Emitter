...
using ExternalOrderReportsService.DataAccess;
...
{
    [DbContext(typeof(ExternalOrderReportsServiceDbContext))]
    partial class ExternalOrderReportsServiceDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmitterPersonalAccount.Core.Domain.Models.Postgres.Registrator", b =>
                {
                    b.OwnsOne("EmitterPersonalAccount.Core.Domain.Models.Postgres.EmitterModel.LocationVO.Location", "Location", b1 =>
                        {
                            b1.Property<Guid>("RegistratorId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("RegistratorId");

                            b1.ToTable("Registrator");

                            b1.WithOwner()
                                .HasForeignKey("RegistratorId");

                            b1.OwnsOne("EmitterPersonalAccount.Core.Domain.Models.Postgres.EmitterModel.LocationVO.Address", "Address", b2 =>
                                {
                                    b2.Property<Guid>("LocationRegistratorId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("LocationRegistratorId");

                                    b2.ToTable("Registrator");

                                    b2.WithOwner()
                                        .HasForeignKey("LocationRegistratorId");
                                });
                    ...
                    b.OwnsOne("EmitterPersonalAccount.Core.Domain.Models.Postgres.EmitterModel.EmitterVO.OGRNInfo", "OGRN", b1 =>
                        {
                            b1.Property<Guid>("RegistratorId")
                                .HasColumnType("uuid");
